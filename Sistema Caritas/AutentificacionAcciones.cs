...
{
    public partial class AutentificacionAcciones : Form
    {
        public delegate void AdminAvailableEventHandler(bool T);
        public event AdminAvailableEventHandler AdminAvailable;
        ...
        public AutentificacionAcciones()
        {
            InitializeComponent();
        }
        ...
        private void AutentificacionAcciones_Load(object sender, EventArgs e)
        {
