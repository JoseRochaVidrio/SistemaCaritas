...
{
    public partial class ConsultaExpedienteSillas : Form
    {
        public ConsultaExpedienteSillas()
        {
            InitializeComponent();
        }

        private void ConsultaExpedienteSillas_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ReporteSillasR ver = new ReporteSillasR(idformatosillas);
